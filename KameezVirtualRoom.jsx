...
const closeModal = () => {
  ...
  const silhouetteOptions = ["long", "simple", "short", "layered"];
    ...
    <div className="h-screen bg-gray-100 p-4 flex flex-col md:flex-row gap-4">
      ...
      <div className="w-full md:w-2/3 bg-white rounded-xl shadow-lg flex flex-col items-center justify-center relative sticky top-0 h-screen p-4 pb-20">
        ...
        <div className="relative w-[300px] h-[600px] mb-4">
          ...
          {selectedSilhouette && selectedColor && (
            <div
              ...
              style={{
                ...
                WebkitMaskImage: `url(/images/silhouettes/kameez/${selectedSilhouette}.png)`,
                WebkitMaskRepeat: "no-repeat",
                WebkitMaskSize: "contain",
                WebkitMaskPosition: "center",
                maskImage: `url(/images/silhouettes/kameez/${selectedSilhouette}.png)`,
          ...
          {selectedSilhouette && !selectedColor && (
            <img
              src={`/images/silhouettes/kameez/${selectedSilhouette}.png`}
              alt="Dress"
      ...
      export default KameezVirtualRoom;
